  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto mt-40 px-6 py-4">
          ...
          <div>
            <div className="mb-6 flex items-center gap-3">
              <img
                ...
                className="size-10"
              />
              <h1 className="text-2xl font-normal uppercase">nerdwork</h1>
            </div>
        ...
        {/* Bottom Section */}
        <div className="flex flex-col gap-6 border-t border-neutral-100 pt-8 md:flex-row md:items-center md:justify-between">
